...
Для отработки скрипта я использовал домен http://kareliaminerhub.ru:80 (я использовал свой домен для того чтобы оттестировать возможные ответы, путем редактирования nginx.conf файла и ответы которые он высылает на браузер)
